...
<section class="section">
    <div class="container" style="max-width: 700px;">
        <h1 style="margin-bottom: 0.5rem;">Post a New Job</h1>
        <p style="color: var(--text-light); margin-bottom: 2rem;">Fill out the form below to post a job opening on Jobseeker Philippines.</p>

        <form method="POST" action="/edrian/public/index.php?controller=listing&action=create" class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="email" id="contact_email" name="contact_email" placeholder="recruiter@company.com" required>
                </div>
                ...
                <div style="display: flex; gap: 1rem; margin-top: 2rem;">
                    <button type="submit" class="btn btn-success" style="flex: 1;">Post Job</button>
        ...
        <div class="alert alert-info" style="margin-top: 2rem;">
            <strong>💡 Tip:</strong> A well-written job description will attract more qualified candidates. Include details about responsibilities, requirements, benefits, and your company culture.
        </div>
    </div>
</section>
