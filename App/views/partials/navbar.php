<nav class="navbar">
    <div class="navbar-container">
        <a href="/edrian/public/index.php" class="navbar-brand">
            💼 Jobseeker Philippines
        </a>
        
        <ul class="navbar-menu">
            <li><a href="/edrian/public/index.php">Home</a></li>
            <li><a href="/edrian/public/index.php?controller=listing&action=index">Browse Jobs</a></li>
            <li><a href="/edrian/public/index.php?controller=listing&action=create">Post Job</a></li>
            <li><a href="/edrian/public/index.php?controller=user&action=show">My Profile</a></li>
        </ul>
